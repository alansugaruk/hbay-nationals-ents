...
export default function HipHopKaraokeFormModal({ isOpen, onClose }: Props) {
    ...
    try {
      const res = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: "Hip Hop Karaoke Registration – HBAY Nationals",
          name,
          email,
  ...
  return createPortal(
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="hhk-modal-title"
      ...
      >
        ...
        <div className="flex items-center justify-between mb-5">
          <h2 id="hhk-modal-title" className="font-extrabold text-lg">
        ...
        <p className="text-slate-400 text-xs mb-5 leading-relaxed">
          Hip Hop Karaoke · Mon 17 Aug · 18:00 – 20:00 · Beach Marquee
        </p>
        ...
        {formState === "success" ? (
          <div className="text-center py-8">
            ...
            <p className="text-slate-300 text-sm">
              We&apos;ll be in touch closer to the event with your slot details.
            </p>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} noValidate={false}>
            ...
            <div className="flex flex-col gap-4">
              <div>
                <label htmlFor="hhk-name" className={labelClass}>
              ...
              <div>
                <label htmlFor="hhk-email" className={labelClass}>
              ...
              <div>
                <label htmlFor="hhk-phone" className={labelClass}>
              ...
              <div>
                <label htmlFor="hhk-club" className={labelClass}>
              ...
              <div>
                <label htmlFor="hhk-track" className={labelClass}>
                  What track would you like to perform? <span className="text-red-400">*</span>
                </label>
                <input
                  id="hhk-track"
                  type="text"
              ...
              <div>
                <label htmlFor="hhk-message" className={labelClass}>
