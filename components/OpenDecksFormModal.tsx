...
export default function OpenDecksFormModal({ isOpen, onClose }: Props) {
    ...
    try {
      const res = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: "Open Decks DJ Registration – HBAY Nationals",
          name,
          email,
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-5">
          <h2 id="od-modal-title" className="font-extrabold text-lg">
        ...
        <p className="text-slate-400 text-xs mb-5 leading-relaxed">
          Open Decks · Sun 16 Aug · 18:00 – 20:00 · Beach Marquee
        </p>
        ...
        {formState === "success" ? (
          <div className="text-center py-8">
            ...
            <p className="text-slate-300 text-sm">
              We&apos;ll be in touch closer to the event with slot details.
            </p>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} noValidate={false}>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <label htmlFor="od-email" className={labelClass}>
              ...
              <div>
                <label htmlFor="od-phone" className={labelClass}>
              ...
              <div>
                <label htmlFor="od-club" className={labelClass}>
              ...
              <div>
                <label htmlFor="od-stage" className={labelClass}>
                  Stage Name <span className="text-slate-500 font-normal">(optional)</span>
                </label>
                <input
                  id="od-stage"
                  type="text"
                  ...
                  placeholder="e.g. DJ Sandbag"
                  className={inputClass}
                />
              </div>

              <div>
                <label htmlFor="od-genres" className={labelClass}>
                ...
                <input
                  ...
                  placeholder="e.g. House, Techno, Jungle"
                  className={inputClass}
                />
              </div>

              <div>
                <label htmlFor="od-message" className={labelClass}>
